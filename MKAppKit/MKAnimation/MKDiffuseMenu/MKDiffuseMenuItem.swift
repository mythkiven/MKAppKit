...
@objc public protocol MKDiffuseMenuItemDelegate : NSObjectProtocol {
    
    @objc func MKDiffuseMenuItemTouchesBegan(_ item: MKDiffuseMenuItem)
    
    @objc func MKDiffuseMenuItemTouchesEnd(_ item: MKDiffuseMenuItem)
}

open class MKDiffuseMenuItem : UIImageView {
    ...
    var delegate: MKDiffuseMenuItemDelegate!
    ...
    open override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        delegate?.MKDiffuseMenuItemTouchesBegan(self)
    }
